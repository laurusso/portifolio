  ...
  return (
    <section id="sobre">
      ...
      <p>
        ...
        modelagem de dados. Também possuo experiência com problemas de lógica de
        programação, algoritmos e estrutura de dados, utilizando principalmente
        a linguagem C.
      </p>

      <p>
        Concluí o ensino médio integrante ao técnico em Informática em 2023 pelo
        Colégio Técnico Industrial "Prof Isaac Portal Roldán" (CTI), da
        ...
        robótica, com foco em atividades educativas para crianças e adolescentes
        da rede pública de ensino de Bauru.
      </p>
    </section>
  );
}
